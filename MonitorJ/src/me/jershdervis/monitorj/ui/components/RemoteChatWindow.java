 ...
 */
public class RemoteChatWindow extends javax.swing.JFrame {
    ...
    public RemoteChatWindow() {
        ...
        this.initComponents();
        setIconImage(ResourceLoader.CLIENT_REMOTE_CHAT.getImage());
    ...
    private void initComponents() {
        ...
        addWindowListener(new WindowAdapter() {
            ...
            public void windowClosing(WindowEvent e) {
                try {
                    client.getDataOutputStream().writeByte(Packets.REMOTE_CHAT_STOP);
    ...
    private void sendMessage(BaseServerClient client) {
        try {
            client.getDataOutputStream().writeByte(Packets.REMOTE_CHAT_MESSAGE);
    ...
    public void setClient(BaseServerClient c) {
        this.client = c;
        setTitle("Remote Chat with " + c.CLIENT_PC_NAME + ":" + c.CLIENT_USER_NAME);
    }
}
